...
public abstract class BaseChannel  implements Serializable {
	...
	private java.util.Set<com.jeecms.cms.entity.main.CmsDepartment> departments;
	...
	public java.util.Set<com.jeecms.cms.entity.main.CmsDepartment> getDepartments() {
		return departments;
	}

	public void setDepartments(
			java.util.Set<com.jeecms.cms.entity.main.CmsDepartment> departments) {
