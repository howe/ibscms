...
public class ContentDaoImpl extends HibernateBaseDao<Content, Integer>
	...
	public Pagination getPageByRight(String title, Integer typeId,
			Integer inputUserId, boolean topLevel, boolean recommend,
			ContentStatus status, Byte checkStep, Integer siteId,
			Integer channelId, Integer[]departIds, Integer userId, boolean selfData, int orderBy,
		...
		if (channelId != null) {
			...
			if(departIds!=null&&departIds.length>0){
				f.append(" and depart.id in(:departIds)");
				f.setParamList("departIds", departIds);
			}
	...
	private void appendGroupBy(Finder f, int orderBy) {
		switch (orderBy) {
		case 7:
			// 周访问降序
			f.append(", bean.contentCount.viewsWeek ");
			break;
		case 8:
			// 月访问降序
			f.append(" ,bean.contentCount.viewsMonth ");
			break;
		case 9:
			// 总访问降序
			f.append(" , bean.contentCount.views ");
			break;
		case 11:
			// 周评论降序
			f.append(" , bean.contentCount.commentsWeek ");
			break;
		case 12:
			// 月评论降序
			f.append(", bean.contentCount.commentsMonth ");
			break;
		case 13:
			// 总评论降序
			f.append(" , bean.contentCount.comments ");
			break;
		case 15:
			// 周下载降序
			f.append(" , bean.contentCount.downloadsWeek ");
			break;
		case 16:
			// 月下载降序
			f.append(" , bean.contentCount.downloadsMonth ");
			break;
		case 17:
			// 总下载降序
			f.append(" , bean.contentCount.downloads desc");
			break;
		case 19:
			// 周顶降序
			f.append(" , bean.contentCount.upsWeek ");
			break;
		case 20:
			// 月顶降序
			f.append(" , bean.contentCount.upsMonth ");
			break;
		case 21:
			// 总顶降序
			f.append(" , bean.contentCount.ups ");
			break;
	 }
	}
