...
public class RegisterAct {
    ...
    public String submit(String username,
        ...
        if (config.getEmailValidate()) {
            ...
            if (sender == null) {
                ...
                try {
                    cmsUserMng.registerMember(username,
                                              email,
                                              password,
                                              ip,
                                              null,
    ...
    private WebErrors validateSubmit(String username,
        ...
        if (errors.ifNotUsername(username, "username", mcfg.getUsernameMinLen(), 100)) {
            return errors;
        }
    ...
    private WebErrors validateActive(String username,
