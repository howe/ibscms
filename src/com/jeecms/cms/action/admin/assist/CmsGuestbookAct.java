...
public class CmsGuestbookAct {
	...
	public String list(Integer queryCtgId, Boolean queryRecommend,
		...
		Integer ctgIds[]=getDepartmentCtgIds(user.getDepartmentIds());
		Pagination pagination = manager.getPage(site.getId(),ctgIds,null,
	...
	private Integer[] getDepartmentCtgIds(Integer departIds[]){
