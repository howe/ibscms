...
public class ChannelMngImpl implements ChannelMng {
	...
	@Transactional(readOnly = true)
	public List<Channel> getTopListForDepartIds(Integer[]departIds,Integer siteId,boolean hasContentOnly){
		return dao.getTopListForDepartIds(departIds,siteId,hasContentOnly);
	}
	...
	@Transactional(readOnly = true)
	public List<Channel> getChildListByDepartIds(Integer[]departIds,Integer siteId,
			Integer parentId, boolean hasContentOnly){
		return dao.getChildListByDepartIds(departIds,siteId,parentId,hasContentOnly);
	}
